        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 px-5">
            <div class="md:flex md:items-center md:justify-between">
                <div class="flex-1 min-w-0">
                    <h1 class="py-0.5 text-2xl font-semibold text-gray-900">HTML Snippets</h1>
                </div>
                <div class="mt-4 flex md:mt-0 md:ltr:ml-4 md:rtl:mr-4">
                    <router-link
                        class="btn btn-blue shadow-sm rounded-md"
                        to="/admin/snippets/create"
                    >
                        Create new Snippet
                    </router-link>
                </div>
                                        ...
                                        <div class="min-w-0 flex-1 flex items-center">
                                            <div class="min-w-0 flex-1 ltr:mr-4 rtl:ml-4 lg:grid lg:grid-cols-2 lg:gap-4">
                                                ...
                                                <div class="flex justify-end">
                                                    ...
                                                    <router-link
                                                        :to="'/admin/snippets/' + snippet.id + '/edit'"
...
export default {
    ...
    methods: {
        getSnippets() {
            ...
            axios.get('/api/admin/snippets').then(function (response) {
                //set items and then reset loading
                self.snippetsList = response.data.items;
                self.loading = false;
            }).catch(function () {
                //reset loading
                self.loading = false;
